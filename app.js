...
const port = vars.PORT || 5888;
const ADMIN = vars.USER_ID; 
const NAMA_STORE = vars.NAMA_STORE || '@kcepu877';
...
bot.action(/(create|renew)_username_(ssh)_(.+)/, async (ctx) => {
